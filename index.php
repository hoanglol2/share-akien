...
<body>
    ...
    <div id="fb-root"></div>    
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v8.0&appId=382369422938181&autoLogAppEvents=1" nonce="O8kuKiWK">
    </script>
    ...
    <!-- Load Facebook SDK for JavaScript -->
      ...
      <div class="fb-customerchat"
        ...
        page_id="103963748135103"
      theme_color="#40A944"
      logged_in_greeting="Xin chào ! FreshGarden có thể giúp gì cho bạn?"
      logged_out_greeting="Xin chào ! FreshGarden có thể giúp gì cho bạn?">
      </div>
</body>
</html>
