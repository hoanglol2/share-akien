            ...
            <div class="row align-items-center">
                ...
                <div class="col-4">
                    <div class="header-top__nav text-right">
                        <ul>
                            <li><a href="https://twitter.com/IvanNgu58576890"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.facebook.com/Freshgarden-103963748135103/?modal=admin_todo_tour"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.youtube.com/channel/UCIAdCeu2r6E2LlCup6mAf-Q?view_as=subscriber"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.instagram.com/ahoang.n/?hl=vi"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="header-bottom-menu">
                        <ul>
                            <li class="header-bottom-menu__item"><a href="trang-chu" class="active">Trang chủ</a></li>
                            <li class="header-bottom-menu__item"><a id="product-shop" href="cua-hang">Cửa hàng</a></li>
                            <li class="header-bottom-menu__item"><a href="san-pham-yeu-thich">Sản phẩm&nbsp;<span class="lnr lnr-heart"></span></a></li>
                            <li class="header-bottom-menu__item header-bottom--blog"><a href="bai-viet">Bài viết</a></li>
                            <li class="header-bottom-menu__item"><a href="lien-he">Liên hệ</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="header-bottom__contact text-right">
                        <p>
                            <a href="tel:(09) 888 999 82"> (09) 888 999 82 </a>
                            hỗ trợ khách hàng
                        </p>
                    </div>
                </div>
