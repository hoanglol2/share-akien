        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
               <div class="contact_message content">
                    <h3>Liên Hệ</h3>    
                     <p>FreshGarden - Thực phẩm sạch số 1 Việt Nam</p>
                    <ul>
                        <li><i class="fa fa-fax"></i>  Địa Chỉ : T8 - Times city - Minh Khai - Hà Nội</li>
                        <li><i class="fa fa-envelope-o"></i> <a href="#">freshgarden.staff@gmail.com</a></li>
            ...
            <div class="col-lg-6 col-md-6 col-12">
               <div class="contact_message form">
                    <h3 class="contact_message--pc">FreshGarden cảm ơn đóng ghóp của bạn!</h3>   
