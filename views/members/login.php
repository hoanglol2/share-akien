	          ...
	          <div class="account-content">
	            ...
	            <form action="" method="POST" onsubmit="return loginForm();">
	              ...
	              <div class="account-title">
	                ...
	                <p class="account-desc">FreshGarden là trang web bán thực phẩm uy tín số 1, Đăng nhập vào để nhập các ưu đãi lớn.</p>
	                <a href="dang-nhap"><img class="img-fluid" src="assets/images/users/avatar.svg" alt="avatar admin freshgarden"></a>
	              </div>
	              ...
	              <div class="account-form account-tab">
	                ...
	                <div class="account-form-inp">
	                  ...
	                  <input onblur="checkEmailLogin();" type="email" class="input-emai" id="input-email" name="" id="email" placeholder="Eg: freshgarden.vn" autocomplete="current-email">
