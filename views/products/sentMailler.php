...
<?php  
	...
	<section id="mailler" style="width: 100%; height: auto;background-color: #f2f2f2; padding: 18px 0; font-size: 12px;">
		<div class="mailler-box" style="width: 600px; min-height: 400px; margin: 0 auto; height: 100%;background-color: #fff;">
			<!-- bg-grren -->
			<div class="mailler-header" style="width: 100%;height: 90px;background-color: #40A944;text-align: center; color: #fff;">
				<h4 style="font-size: 23px;margin: 0 0 6px; padding-top: 6px;">FreshGarden</h4>
			...
			<div class="mailler-main" style="padding: 18px; ">
				...
				<p style="margin: 5px 0 45px;">Chúng tôi vừa bàn giao đơn hàng của quý khách đến đối tác vận chuyển FreshGarden Team. Đơn hàng của quý khách sẽ được giao trong ngày hôm nay '.$date_order.'</p>
				<strong style="font-weight: 600; color: #40A944; font-size: 14px;">THÔNG TIN ĐƠN HÀNG '.'#'.$pinCode.' <span style="font-size: 12px;color: #333; opacity: .9">( '.$date_order.' )</span></strong>
				<hr>
				...
				<div style="display: flex; justify-content: space-between;">
					<div style="padding-right: 25px; width: 30%;">
						...
						<a href="#" style="margin: 0 0 2px; display: block; color: #40A944;">'.$email.'</a>
						...
						<?php
							...
							if (isset($_SESSION['array_sent_mail_index']) && $_SESSION['array_sent_mail_index'] == 3) {
								...
								<a href="#" style="color: #40A944;">FreshGarden.vn</a>';	
				...
				<div>
					<h6 style="margin: 0 0 15px; font-size: 14px; text-transform: uppercase; color: #40A944;">Chi tiết đơn hàng</h6>
					<table style="width: 100%; margin-bottom: 25px; border-collapse: collapse;">
						<thead>
							<tr style="background-color: #40A944; color: #fff; text-align: left;">
					...
					<div class="mailer-end">
						<p style="margin: 0 0 5px;">Xem thêm <a href="#" style="color: #40A944;">các câu hỏi thường gặp.</a></p>
						<p style="margin: 0 0 5px;">Truy cập <a href="#" style="color: #40A944;">hotro.FreshGarden.vn</a>, hoặc gọi số điện thoại <a href="tel:(09) 728 534 98"></a>(09) 728 534 98 (8-21h cả T7,CN) để gặp nhân viên chăm sóc khách hàng khi quý khách cần hỗ trợ.</p>
						<strong style="margin: 0 0 5px; display: block;">FreshGarden cảm ơn quý khách,</strong>
						<div>
							<p style="margin: 0 0 5px;">Coppy&copyright by freshgarden 2020.</p>
							<strong style="text-align: right; width:100%;">FreshGarden</strong>
						</div>
					</div>
				</div>
			</div>
	...
	try {
	    ...
	    $mail->Username   = 'freshgarden.staff@gmail.com'; // Mail của admin.              // SMTP username
	    $mail->Password   = 'Maiyeuem';    // Pass của admin.                        // SMTP password
	    $mail->SMTPSecure = 'tls'; 
	    $mail->Port       = 587;   

	    //Recipients
	    $mail->setFrom('freshgarden.staff@gmail.com', 'FreshGarden'); // 
	    $mail->addAddress($email, $name); // customer email.
	    $mail->addReplyTo('freshgarden.staff@gmail.com', 'Khách hàng của FreshGarden'); //customer replies to email
