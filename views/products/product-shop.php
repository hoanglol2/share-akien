                    ...
                    <div class="widget-inner">
                        ...
                        <div class="widget-list banner-widget">
                            <div class="banner-thumb">
                                <a href="cua-hang">
                                    <img class="img-fluid banner-widget--pc" src="assets/images/bg/banner17.jpg" alt="Banner shop freshgarden">
                                    <img class="img-fluid banner-widget--mobile" src="assets/images/bg/banner6.jpg" alt="Banner shop freshgarden">
                                </a>
                            </div>
                        </div>
                    </div>
