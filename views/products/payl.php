                    ...
                    <div class="col-lg-7">
                        <div class="payl-top">
                            ...
                            <div class="payl-titlebanner">
                                ...
                                <div>
                                    <p>chi tiết khuyến mãi : <a href="#">freshgarden.vn/khuyenmaithang9</a></p>
                                </div>
                            </div>
                            <!-- ./titleBanner -->
                                    ...
                                    <?php
                                            ...
                                            <div class="account-form account-tab">
                                                ...
                                                <div class="account-form-inp">
                                                  ...
                                                  <input onblur="checkEmailLogin();" type="email" class="input-emai payl-input" id="input-email" placeholder="Eg: freshgarden.vn" autocomplete="current-email">
                                ...
                                <div class="payl-address">
                                    ...
                                    <div class="payl-address__content payl-shippings__item">
                                        <label class="payl-label">
                                            ...
                                            <span> <span class="font-weight-bold">ShowRoom GardenFresh.com | VinCom Bà Triệu :</span> Showroom GardenFresh.com – Tháp G, Vincom Center Bà Triệu, Quận Hai Bà Trưng, Hà Nội</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="payl-sent">
                                    <center>
                                        ...
                                        <p class="payl-desc">
                                            ...
                                            <strong style="color: var(--primary-color)">Nội dung : </strong> "Khách hàng của FreshGarden"<br/>
                                            <strong>Số tài khoản : </strong> 0456668889<br/>
                                            <strong>Tài khoản Techcombank</strong> <br/>
                                            <strong>Chủ tài khoản:</strong> CÔNG TY TNHH MixiFood <br/>
                                            Ngân hàng kỹ thương Việt Nam <br/>
                                            Chi nhánh Lĩnh Nam
                                        </p>
                                        <p class="payl-desc">
                                ...
                                foreach ($_SESSION['cart1998'] as $key => $product) { ?>
                                    <div class="d-flex align-items-center justify-content-between py-3 img-fluid">
                                        ...
                                        <div class="payl__price">
                                            ...
                                            <p class="payl-mass color-primary">(<?php echo $product['mass']; ?>)</p>
                                        </div>
                                    </div>
                            <?php
                               }
